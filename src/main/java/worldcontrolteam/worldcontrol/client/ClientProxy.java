...
public class ClientProxy extends CommonProxy {
    ...
    public void preinit(FMLPreInitializationEvent event) {
        ...
        ClientRegistry.bindTileEntitySpecialRenderer(TileHolographicDisplay.class, new TESRHoloDisplay());
        ClientRegistry.bindTileEntitySpecialRenderer(TileInformationPanel.class, new TESRInformationPanel());
    }
    ...
    public void modelEvent(ModelRegistryEvent event) {
        ...
        registerWithMapper(WCBlocks.HOLO_DISPLAY);
        registerWithMapper(WCBlocks.EXTENDER);
        registerWithMapper(WCBlocks.PANEL);
